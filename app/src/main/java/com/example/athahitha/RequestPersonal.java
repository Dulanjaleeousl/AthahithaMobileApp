...
public class RequestPersonal extends AppCompatActivity {

    Button location;
    Button submit;
    TextView captureText1,captureText2,captureText3,captureText4,captureText5,captureText6,captureText7,captureText8,captureText9 ;
    EditText name,age,address,contactnumber,gnd,ds,bankname,branch,accHolder,accNumber,category,description;
    Uri uri1,uri2,uri3,uri4,uri5,uri6,uri7,uri8,uri9;
    private ImageView captureImage1,captureImage2,captureImage3,captureImage4,captureImage5,captureImage6,captureImage7,captureImage8,captureImage9;
    Button birthday;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.request_personal);

        Objects.requireNonNull(getSupportActionBar()).setTitle("Requester");
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("User Requests");
        ...
        location.setOnClickListener(view -> {
            Intent intent = new Intent(RequestPersonal.this, CurrentLocation.class);
        ...
        captureImage1.setOnClickListener(v -> ImagePicker.Companion.with(RequestPersonal.this)
                .crop()
        ...
        captureImage2.setOnClickListener(v -> ImagePicker.Companion.with(RequestPersonal.this)
                .crop()
                .maxResultSize(1080,1080)
                .start(102));
        ...
        captureImage3.setOnClickListener(v -> ImagePicker.Companion.with(RequestPersonal.this)
                .crop()
                .maxResultSize(1080,1080)
                .start(103));
        ...
        captureImage4.setOnClickListener(v -> ImagePicker.Companion.with(RequestPersonal.this)
                .crop()
                .maxResultSize(1080,1080)
                .start(104));
        ...
        captureImage5.setOnClickListener(v -> ImagePicker.Companion.with(RequestPersonal.this)
                .crop()
                .maxResultSize(1080,1080)
                .start(105));
        ...
        captureImage6.setOnClickListener(v -> ImagePicker.Companion.with(RequestPersonal.this)
                .crop()
                .maxResultSize(1080,1080)
                .start(106));
        ...
        captureImage7.setOnClickListener(v -> ImagePicker.Companion.with(RequestPersonal.this)
                .crop()
                .maxResultSize(1080,1080)
                .start(107));
        ...
        captureImage8.setOnClickListener(v -> ImagePicker.Companion.with(RequestPersonal.this)
                .crop()
                .maxResultSize(1080,1080)
                .start(108));
        ...
        captureImage9.setOnClickListener(v -> ImagePicker.Companion.with(RequestPersonal.this)
                .crop()
                .maxResultSize(1080,1080)
                .start(109));
...
//add photo
    ...
    private void showSuccessDialog(){
        ...
        View view = LayoutInflater.from(RequestPersonal.this).inflate(R.layout.success_dialog, successConstraintLayout);
        Button successhome = view.findViewById(R.id.succeshome);

        AlertDialog.Builder builder = new AlertDialog.Builder(RequestPersonal.this);
        ...
        successhome.findViewById(R.id.succeshome).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                alertDialog.dismiss();
                Toast.makeText(RequestPersonal.this, "Done", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(RequestPersonal.this, Home.class);
                startActivity(intent);
            }
        });
    ...
    private void insertRequestData(){
        ...
        DataClass dataClass = new DataClass(dataName,dataAge,dataAddress,dataBirthday,dataContactNumber,dataGND,dataDS,dataBankName,dataBranch,dataAccountNumber,dataAccountHolder,dataCategory,dataDescription);
